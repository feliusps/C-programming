/*In this task you will continue working on the linked list of students in which
 you would like to store, for each student, their name and age. 
...
If you were unable to solve the previous task you have the option 
to be given the code for the createStudent() function 
...
Your new task is to write a function append() which takes as input two pointers:
 ...
 this new student to the linked list and return the address (a struct student *) 
