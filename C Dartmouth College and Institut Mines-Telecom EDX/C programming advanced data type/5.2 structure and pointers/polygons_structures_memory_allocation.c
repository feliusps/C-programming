...
Your main function should read the number of vertices to store in 
the array of points from the user, then allocate the appropriate 
amount of memory, initialize the array with the function initializePoly, 
...
int main(void) {
   ...
   printf("How many vertices does your poligon have?\n");
   scanf("%d", &N); 
   //allocate the appropiate amount of memory
   struct point array[N];
   //call to initialize fuction
   initializePoly(array, N);
