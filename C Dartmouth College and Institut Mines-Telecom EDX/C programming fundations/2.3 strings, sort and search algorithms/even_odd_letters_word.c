...
letters, the other for those whose names have an even number of letters. 
...
value (1 or 2) depending on whether the fan should join line 1 
...
int main(void)
{
    //variable defitition and declaration
    ...
    printf("Please write the student name\n");
    ...
    //decide line number with condicional
    if (i%2 == 0)
    {
        printf("%d\n",even);
    }
